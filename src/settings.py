...
KNIGHT_SPRITE_DIR = os.path.join(ASSET_DIR, "characters", "knight")
SLIME_SPRITE_DIR = os.path.join(ASSET_DIR, "monsters", "slime")
KING_SLIME_SPRITE_DIR = os.path.join(ASSET_DIR, "bosses", "king_slime")
HUB_MAP_DIR = os.path.join(ASSET_DIR, "maps", "hub")
DUNGEON_MAP_DIR = os.path.join(ASSET_DIR, "maps", "dungeon")
UI_SPRITE_DIR = os.path.join(ASSET_DIR, "ui")
